...
| `impact -> context -> rg` (refactor path) | `impact: f1=0.848 (P=0.739,R=0.933), p50=191.951ms, tok=26`; `context: f1=0.880 (P=0.800,R=1.000), p50=15516ms, tok=128`; `rg: mrr=0.813, r@5=0.877, p@5=0.175, fpr@5=0.000` | `N/A` | `N/A` | `benchmark/runs/h2h-llm-tldr-score-run1-fixed-stitched-allowlist-20260302T062602Z.json`; `benchmark/runs/h2h-rg-native-score-run1-retrieval-b2000-t123-segment.json`; `/tmp/context-score2.json` |
